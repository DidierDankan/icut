const Terms = () => {
    return (
        <>
            <header>
                <h1>Termos de Uso e Serviço da onyou</h1>
            </header>

            <main>
                <section>
                    <p>Seja Bem-Vindo ao site da onyou. Antes de explorar tudo o que temos a oferecer, é importante que você entenda e concorde com algumas regras básicas que regem o uso do nosso site <a href="https://icut.vercel.app/" target="_blank">https://icut.vercel.app/</a>, e qualquer outro serviço digital que nós oferecemos, como lojas e plataformas de e-commerce.</p>
                    ...
                    <p>Se tiver dúvidas sobre estes termos, não hesite em nos contatar através do e-mail <a href="mailto:onyoubr@gmail.com">onyoubr@gmail.com</a>.</p>
                </section>
            </main>

            <footer>
                <p>&copy; 2024 onyou - Todos os direitos reservados.</p>
            </footer>
        </>
    )
}
